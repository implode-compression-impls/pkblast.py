...
[wheel (GHA via `nightly.link`)](https://nightly.link/KOLANICH-libs/pkblast.py/workflows/CI/master/pkblast-0.CI-py3-none-any.whl)
...
[![Coveralls Coverage](https://img.shields.io/coveralls/KOLANICH-libs/pkblast.py.svg)](https://coveralls.io/r/KOLANICH-libs/pkblast.py)
[![GitHub Actions](https://github.com/KOLANICH-libs/pkblast.py/workflows/CI/badge.svg)](https://github.com/KOLANICH-libs/pkblast.py/actions/)
[![Libraries.io Status](https://img.shields.io/librariesio/github/KOLANICH-libs/pkblast.py.svg)](https://libraries.io/github/KOLANICH-libs/pkblast.py)
...
For compression you need [`pkimplode.py`](https://github.com/KOLANICH-libs/pkimplode.py) a separate wrapper to a separate library by another author.
...
In order to make it work you need a package with `liblast` itself installed into your system using your distro package manager. If your distro doesn't provide one, you can build it yourself using CMake CPack from the sources [by the link](https://github.com/KOLANICH-libs/libblast). You will get 3 packages, one with the headers, another one with the shared library, and yet another one with the CLI tool. Only the one with the lib is mandatory.
